...
```{r, echo = F, include = F, interval = 0.1, cache = TRUE}
...
#animation <- gganimate(plot_it, interval = 0.1, title_frame = FALSE, filename = "/home/john/stats-corner/content/post/2017/belt.gif")

```

![First gif in Stats Corner history](/home/john/stats-corner/content/post/2017/belt.gif)
