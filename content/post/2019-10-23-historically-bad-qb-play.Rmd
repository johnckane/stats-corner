...
Over on the redesigned message board (I've overlooked it at the bottom of the League Home page all season) Tim asks:
...
This is both easy and hard to answer. Easy because I've got data for all players/teams going back to 2001 in a tidy database. Hard because I don't know which players were carried on specific rosters or started in specific weeks. Nor does ESPN allow you to go back and check box scores for the history of the league. Also, the 2019 data isn't in that database yet so we'll rely on data from 2009-2018. I do have our draft data and can tell which owners drafted certain players. We'll use that as a proxy for playing them. 
...
I doubt Peterman started for anyone back in 2017 after signing as a free agent. But did Ready start John Skelton back in 2012? If not Darnold would take the spot as likey the worst performance ever. As it stands it is the fourth worst by a non-D/ST across the entirity of the NFL from 2009-2018.
...
How about worst combination when the two QBs were at least drafted by the same owner? Can't tell if they started for that owner that week though. 
...
Darnold scored -6.7 points on Monday night, and unless Ready started John Skelton back in Week 10 2014 it is likely the worst performance by any single player in Bad Newz.
