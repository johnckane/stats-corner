---
title: "Bad Newz Record Book"
output: html_document
date: "Through 2022 Season"
---
```{r, include = FALSE}
...
#### Most Points
```{r, echo = FALSE}
DT::datatable(top10_single_game_points, options = list(paging = FALSE))
```
#### Fewest Points
```{r, echo = FALSE}
DT::datatable(btm10_single_game_points, options = list(paging = FALSE))
```
### {-}
### Single Season {.tabset}
#### Most Points
```{r, echo = FALSE}
DT::datatable(top10_season_points, options = list(paging = FALSE))
```
#### Fewest Points
```{r, echo = FALSE}
DT::datatable(btm10_season_points, options = list(paging = FALSE))
```
####
#### Most PW
```{r, echo = FALSE}
DT::datatable(top10_season_pw, options = list(paging = FALSE))
```
####
#### Fewest PW
```{r, echo = FALSE}
DT::datatable(btm10_season_pw, options = list(paging = FALSE))
```
####
#### Most Wins
```{r, echo= FALSE}
DT::datatable(top10_season_w, options = list(paging = FALSE))
```
#### Fewest Wins
```{r, echo = FALSE}
DT::datatable(btm10_season_w, options = list(paging = FALSE))
```
...
#### Per Game Averages
```{r, echo = FALSE}
DT::datatable(career_game, options = list(paging = FALSE))
```
#### Totals
```{r, echo = FALSE}
DT::datatable(career_totals, options = list(paging = FALSE))  
```
